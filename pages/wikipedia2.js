(function (window, undefined) {
    ...
    jQuery.support = (function () {
        ...
        jQuery(function () {
            ...
            div.innerHTML = "";
            div.style.
            cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;";
    ...
    jQuery.event = {
        ...
        mouseHooks: {
            ...
            filter: function (event, original) {
                ...
                if (
                event.pageX == null && original.clientX != null) {
        ...
        jQuery.event.special.change = {
            setup: function () {
                ...
                jQuery.event.add(this, "beforeactivate._change", function (e) {
                    ...
                    nodeName) && !jQuery._data(elem, "_change_attached")) {
    ...
    jQuery.each(("blur focus focusin focusout load resize scroll unload click dblclick " + "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave " + "change select submit keydown keypress keyup error contextmenu").split(" "), function (i, name) {
        ...
        if (rkeyEvent.test(name)) {
            jQuery.event.
            fixHooks[name] = jQuery.event.keyHooks;
        }
    ...
    (function (window, undefined) {
        ...
        function select(selector, context, results, seed, xml) {
            ...
            compile(selector, match)(seed, context, xml,
            results, rsibling.test(selector));
            return results;
        }
    ...
    function findOrAppend(elem, tag) {
        ...
        return elem.
        getElementsByTagName(tag)[0] || elem.appendChild(elem.ownerDocument.createElement(tag));
    }
                ...
                if (typeof elem === "string") {
                    if (!rhtml.test(elem)) {
                        ...
                        if (!jQuery.support.leadingWhitespace && rleadingWhitespace.test(elem)) {
                            ...
                            createTextNode(rleadingWhitespace.exec(elem)[0]), div.firstChild);
                        }
                        elem = div.childNodes;
        ...
        for (; i < length && (executeOnly || !selection); i++) {
            ...
            if (typeof selection === "string") {
                if (!executeOnly || inspected[selection]) {
                    ...
                    selection = inspectPrefiltersOrTransports(structure, options, originalOptions, jqXHR,
                    selection, inspected);
                }
            }
        }
    ...
    function ajaxHandleResponses(s, jqXHR, responses) {
        var ct,
        type, finalDataType, firstDataType, contents = s.contents,
            ...
            jQuery.fn[funcName] = function (margin, value) {
                ...
                return jQuery.access(this, function (elem, type, value) {
                    ...
                    if (elem.nodeType === 9) {
                        ...
                        return Math.max(elem.body["scroll" + name], doc["scroll" + name], elem.body["offset" + name], doc[
                            "offset" + name], doc["client" + name]);
                    }
    ...
    return {
        ...
        loader: (function () {
            ...
            function addEmbeddedCSS(cssText) {
                ...
                if ($style.data('ResourceLoaderDynamicStyleTag') === true && canExpandStylesheetWith($style, cssText)) {
                    styleEl = $style.get(0);
            ...
            function formatVersionNumber(timestamp) {
                ...
                return [pad(d.getUTCFullYear(), d.getUTCMonth() + 1, d.getUTCDate()), 'T', pad(d.getUTCHours(), d.getUTCMinutes(), d.getUTCSeconds()), 'Z'].join('');
            }
                ...
                for (n = 0; n < len; n += 1) {
                    if ($.inArray(deps[n], resolved) === -1) {
                        if (unresolved[deps[n]]) {
                            throw new Error('Circular reference detected: ' + module + ' -> ' + deps[n]);
                        }
            ...
            function request(dependencies, ready, error, async) {
                ...
                if (ready !== undefined || error !== undefined) {
                    jobs[jobs.length] = {
                        'dependencies': filter(['registered', 'loading', 'loaded'], dependencies),
                        'ready': ready,
                        'error': error
                    };
                }
            ...
            return {
                ...
                work: function () {
                    ...
                    bSource, bGroup, bSourceGroup, source, group, g, i, modules, maxVersion, sourceLoadScript, currReqBase, currReqBaseLength, moduleMap, l, lastDotIndex, prefix, suffix, bytesAdded, async;
                    reqBase = {
                    ...
                    for (source in splits) {
                        ...
                        for (group in splits[source]) {
                            ...
                            currReqBase = $.extend({
                                version: formatVersionNumber(maxVersion)
                            }, reqBase);
                            ...
                            for (i = 0; i < modules.length; i += 1) {
                                ...
                                bytesAdded = moduleMap[prefix] !== undefined ? suffix.length + 3 : modules[i].length + 3;
                ...
                using: function (dependencies, ready, error) {
                    ...
                    if (allReady(dependencies)) {
                        ...
                        if ($.isFunction(error)) {
                            error(new Error('one or more dependencies have state "error" or "missing"'), dependencies);
                        }
                    } else {
    ...
    $.fn.loadingSpinner = function (opts) {
        ...
        if (mw.config.get('LoadingSpinner.ImageUrl')) {
            this.each(function () {
                ...
                if (opts !== false) {
                    var $loadingSpinner = $('<img />').attr("src", mw.config.get('LoadingSpinner.ImageUrl')).load(function () {
                        $(this).css({
...
(function (mw, $) {
    ...
    mw.addLoaderDialog = function (dialogHtml) {
        ...
        $dialog = mw.addDialog({
            'title': dialogHtml,
            'content': dialogHtml + '<br>' + $('<div />').loadingSpinner().html()
        });
        return $dialog;
    };
...
/* cache key: enwiki:resourceloader:filter:minify-js:7:c9d79eeb1a624b618bc2c64f4e63c285 */
