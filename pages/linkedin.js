...
if (typeof window.console.warn !== "function") {
    ...
    var R = {
        ...
        ab = "onOnce",
        Z = "script",
        L = "https://www.linkedin.com/uas/js/userspace?v=0.0.2000-RC1.21420-1402",
        h = "https://platform.linkedin.com/js/secureAnonymousFramework?v=0.0.2000-RC1.21420-1402",
        H = "http://platform.linkedin.com/js/nonSecureAnonymousFramework?v=0.0.2000-RC1.21420-1402",
        B = p.getElementsByTagName("head")[0],
        t = p.getElementsByTagName(Z),
        W = [],
        a = [],
        O = ["lang"],
        Q = {}, c = false,
