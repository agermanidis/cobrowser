if (!window.__twttrlr) {
    (function (a, b) {
        ...
        M.Script = z, M.Module = A, M.Collection = B, M.Sequence = C, M.Dependency = y, M.noConflict = N, a.loadrunner = M, a.using = J, a.provide = F, a.define = I, J.path = "", J.matchers = [], J.matchers.add = function (a, b) {
            ...
            var b = new z(a.replace(/^\$/, J.path.replace(/\/$/, "") + "/")
                .replace(/^script!/, ""), !1);
            return b.id = a, b
        }), J.matchers.add(/^[a-zA-Z0-9_\-\/]+$/, function (a) {
            return new A(a)
        }), J.bundles = [], f && (J.path = f.getAttribute("data-path") || f.src.split(/loadrunner\.js/)[0] || "", (main = f.getAttribute("data-main")) && J.apply(a, main.split(/\s*,\s*/))
            .then(function () {}))
    })(this, document);
...
__twttrlr(function (using, provide, loadrunner, define) {
    provide("util/iframe", function (a) {
        a(function (a) {
            var b = (a.replace && a.replace.ownerDocument || document)
                .createElement("div"),
                c;
        ...
        using("util/util", "util/domready", "dom/get", "util/querystring", "util/iframe", function (b, c, d, e, f) {
            ...
            var g = 0,
                h, i, j = {
                    ...
                    he: {
                        "%{followers_count} followers": "%{followers_count} עוקבי??",
                        "100K+": "מאות אלפים",
            ...
            b.aug(l.prototype, {
                setLanguage: function (a) {
                    var b;
                    a || (a = this.params()
                        .lang || this.dataAttr("lang") || m(this.srcEl)), a = a && a.toLowerCase();
    ...
    provide("dom/classname", function (a) {
        function b(a, b) {
            a.classList ? a.classList.add(b) : f(b)
                .test(a.className) || (a.className += " " + b)
        }
        function c(a, b) {
        ...
        function e(a, b) {
            return a.classList ? a.classList.contains(b) : f(b)
                .test(a.className)
        }
        function f(a) {
        ...
        function () {
            ...
            typeof JSON.stringify != "function" && (JSON.stringify = function (a, b, c) {
                ...
                if (/^[\],:{}\s]*$/.test(text.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@")
                    ...
                    .replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return j = eval("(" + text + ")"), typeof reviver == "function" ? walk({
                    "": j
                }, "") : j;
    ...
    provide("tfw/widget/env", function (a) {
        using("util/params", function (b) {
            function d() {
                var a = 36e5,
                    d = b.combined(document.location)
                        ._;
    ...
    provide("dom/cookie", function (a) {
        using("util/util", function (b) {
            a(function (a, c, d) {
                ...
                return (h = (new RegExp("(?:^|; )" + encodeURIComponent(a) + "=([^;]*)"))
                    .exec(document.cookie)) ? i(h[1]) : null
            })
        })
    });
    ...
    provide("tfw/widget/tracking", function (a) {
        using("dom/cookie", "dom/sandbox", "util/donottrack", "tfw/widget/guest_cookie", "tfw/widget/env", "util/util", "$xd/json2.js", function (b, c, d, e, f, g, h) {
            function u() {
                ...
                t = document.getElementById("rufous-sandbox"), t ? (s = t.contentWindow.document, r = s.body) : c(a, {
                    id: "rufous-sandbox"
                }, {
                    display: "none"
                })
            ...
            var i = "twttr_",
                ...
                }, k = ["tweetbutton", "followbutton", "tweetembed", "tweetbox", "timeline", "timeline-poll"],
                l = ["hask", "li", "logged_in", "pid", e.guest_id_cookie, i + "hask", i + "li", i + e.guest_id_cookie],
                m = 0,
                n, o, p = [],
                q, r, s, t;
            e.forceNewCookie(), a({
    ...
    provide("tfw/assets", function (a) {
        using("util/env", function (b) {
            ...
            var c = {
                "embed/timeline.css": {
                    "default": "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.default.css",
                    "2x": "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.2x.css",
                    gif: "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.gif.css",
                    "default.rtl": "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.default.rtl.css",
                    "2x.rtl": "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.2x.rtl.css",
                    "gif.rtl": "embed/timeline.9c37da75f27f61a1bca1d1803af4f6a1.gif.rtl.css"
                },
                "embed/embed.db2c829c654880a40587573127775568.css": {
    ...
    provide("tfw/widget/timeline", function (a) {
        using("anim/transition", "tfw/widget/base", "tfw/widget/intent", "tfw/data", "tfw/assets", "tfw/widget/tracking", "tfw/widget/params", "util/datetime", "util/env", "util/iframe", "util/insert", "util/twitter", "util/querystring", "util/util", "dom/delegate", "dom/classname", "dom/get", "dom/sandbox", function (b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            var t = "1.0",
                ...
                B = 81,
                C = 16,
                D = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:active", ".customisable-highlight:hover", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
                E = ["a:hover .ic-mask", "a:focus .ic-mask"],
                F = "timeline",
                G = "new-tweets-bar",
                H = "timeline-header",
                I = "timeline-footer",
                ...
                X = "show-tweet-box",
                Y = "web-intent";
            $.prototype = new c.Base, o.aug($.prototype, {
                create: function (a) {
                ...
                logImpressions: function (a, b) {
                    var c = r.all(P, a, "A"),
                        d = c.length,
                        e, f = 0;
                    for (; e = c[f]; f++) g.enqueue({
                        widget_id: this.widgetId,
                        tweet_ids: [m.status(e.href)]
                    }, b, !0, this.dnt);
                    f && g.flush()
                },
                addLinkColorStyle: function (a) {
                    ...
                    h = o.map(D, g)
                        .join(",") + "{color:" + a + "}", i = o.map(E, g)
                        .join(",") + "{background-color:" + a + "}", e = c.createElement("style"), e.id = d, e.type = "text/css";
                ...
                loadMore: function () {
                    var a = this,
                        b = r.all(L, this.element, "LI")
                            .pop(),
                        c = b && b.getAttribute("data-tweet-id");
                    this.requestTweets(c, !1, function (b) {
                        var d = r.one(T, a.element, "P"),
                            e = b.childNodes[0];
                ...
                requestTweets: function (a, b, c) {
                    ...
                    f[b ? "sinceId" : "maxId"] = a, f.complete = function () {
                        ...
                        var b = d.sandbox.doc.createDocumentFragment(),
                            e = d.sandbox.doc.createElement("div");
                ...
                appendTweets: function (a) {
                    var b = r.one(J, this.element, "DIV"),
                        c = r.one(K, b, "OL");
                    this.updateTimeStamps(), c.appendChild(a)
                },
                gcTweets: function (a) {
                    var b = r.one(K, this.element, "OL"),
                        c = b.children.length,
                        d;
                    a = a || 50;
                ...
                expandTweetBox: function () {
                    var a = r.one(Q, this.element, "IFRAME"),
                        b = a && a.parentNode;
                    if (!a) return;
                ...
                readTranslations: function () {
                    ...
                    this.i18n = {
                        ...
                        months: a.getAttribute(b + "months")
                            .split("|"),
                        formats: {
            ...
            function j(a) {
                ...
                for (; c < d; c++) {
                    ...
                    if (h && h.nodeType === 3 && e.test(h.nodeValue)) {
                        b.name = RegExp.$1.split(" ")
                            .slice(1)
                            .join(" "), b.screen_name = RegExp.$2;
                        break
                    }
                }
                        ...
                        g(c.lang, function (g) {
                            var h = document.createElement("div"),
                                ...
                                l = {
                                    ...
                                    lang: c.lang,
                                    twt: c.data._wjs_reply ? j.inReplyTo(a._wjs_reply)
                                        .html() : j.html()
                                };
            ...
            j.prototype = new c.TweetBase, b.aug(j.prototype, {
                ...
                width: function () {
                    var a = {
                        ...
                        n = this.styles.base,
                        o = n;
                    return~b.indexOf(["ja", "ko"], this.lang) ? i += this._("10k unit") : i = i.length > h.length ? i : h, c ? (o = n + this.styles.vbubble, m = a.ver, l = a.btn) : this.size == "l" ? (n = o = n + this.styles.large, l = a.xlbtn, m = a.xlcnt) : (l = a.btn, m = a.cnt), this.count != "none" && (k = f(i, "", o)
                        .width + m), j = f(e, "", n + this.styles.button)
                        .width + l, c ? j > k ? j : k : this.calculatedWidth = j + k
                },
                render: function () {
    ...
    provide("tfw/widget/tweetbox", function (a) {
        using("util/util", "tfw/widget/tweetbase", "util/querystring", "util/uri", function (b, c, d, e) {
            ...
            var f = document.title,
                ...
                i = "220px",
                j = 140;
            k.prototype = new c.TweetBase, b.aug(k.prototype, {
                parameters: function () {
                    var a = {
                        related: this.related,
                        lang: this.lang,
                ...
                render: function () {
                    ...
                    this.element = this.create(a, this.srcEl.className, this.dimensions(), {
                        title: this._("Twitter Tweet Box")
                    })
                }
            }), a({
                Embeddable: k
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (b, c, d, e, f, g) {
            ...
            h.prototype = new c.Base, b.aug(h.prototype, {
                ...
                width: function () {
                    ...
                    return this.size == "l" ? (l += this.styles.large, j = a.xlbtn, k = a.xlcnt) : (j = a.btn, k = a.cnt), this.showCount && (i = g(f, "", l)
                        .width + k), h = g(d, "", l + this.styles.button)
                        .width + j, this.calculatedWidth = h + i
                }
            }), a({
                Embeddable: h
            })
        ...
        twttr.events = {
            ...
            c(function () {
                using("util/util", "tfw/widget/follow", "tfw/widget/tweetbox", "tfw/widget/tweetbutton", "tfw/widget/tweetembed", "tfw/widget/timeline", "tfw/widget/intent", "util/events", "tfw/widget/base", function (c, d, e, f, g, h, i, j, k) {
                    ...
                    var l, m, n = {
                        widgets: {
                            "a.twitter-share-button": f.Embeddable,
                            "a.twitter-mention-button": f.Embeddable,
                            "a.twitter-hashtag-button": f.Embeddable,
                            "a.twitter-follow-button": d.Embeddable,
                            "a.twitter-tweet-box": e.Embeddable,
                            "blockquote.twitter-tweet": g.Embeddable,
                            "a.twitter-timeline": h.Embeddable,
                            body: i.Listener
                        }
