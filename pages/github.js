...
function () {
    (typeof Zepto == "undefined" || Zepto === null) && $.ajaxSetup({
...
function () {
    ...
    $(document).on("focusin", ".js-filterable-field", function () {
        ...
        a = $(this).val(), $(this).on("throttled:input.filterable", function () {
            ...
            return a = $(this).val(), $(this).fire("filterable:change", {
                async: !0
            })
        ...
        for (e = 0, f = g.length; e < f; e++) c = g[e], b = $(c), a(b, d), b.fire("filterable:change", {
            relatedTarget: this
        })
    }), a = function (a, b) {
        var c, d, e, f, g, h;
        e = function () {
            ...
            switch (a.attr("data-filterable-type")) {
                case "fuzzy":
                    return a.fuzzyFilterSortList(b, {
                        items: e,
                        content: c,
                        mark: g,
                        limit: f
                ...
                case "substring":
                    return a.substringFilterList(b, {
                        items: e,
                        content: c,
                        mark: g,
                        limit: f
...
function () {
    ...
    }, b = c[Modernizr.prefixed("transition")], a = function (a) {
        var b;
...
function () {
    ...
    $.fn.positionedOffset = function (a) {
        ...
        return !a || !a.offsetParent ? (g = $(document).height(), h = $(document).width()) : (g = a.scrollHeight, h = a.scrollWidth), b = g - (i + d), f = h - (e + j), {
            top: i,
            left: e,
            bottom: b,
            right: f
...
function () {
    $.fn.overflowOffset = function (a) {
        var b, c, d, e, f, g, h, i, j;
        return a == null && (a = document.body), (c = this[0]) ? (f = $(c).positionedOffset(a), a.offsetParent ? h = {
            top: $(a).scrollTop(),
            left: $(a).scrollLeft()
        } : (h = {
            top: $(window).scrollTop(),
            left: $(window).scrollLeft()
        }, a = document.documentElement), i = f.top - h.top, e = f.left - h.left, d = a.clientHeight, j = a.clientWidth, b = d - (i + c.offsetHeight), g = j - (e + c.offsetWidth), {
            top: i,
            left: e,
            bottom: b,
            right: g,
...
function () {
    ...
    $.fn.scrollTo = function () {
        ...
        var c, d, e;
        return e = {}, b.top != null && (e.scrollTop = b.top), b.left != null && (e.scrollLeft = b.left), d = {
            duration: b.duration,
            queue: !1
        }, b.complete && (c = $(a).length, d.complete = function () {
...
function () {
    ...
    c = navigator.userAgent.match(/Macintosh/), m = navigator.userAgent.match(/Macintosh/) ? "meta" : "ctrl", g = !1, n = {
        x: 0,
        y: 0
    }, $.pageUpdate(function () {
        var a, b, c, d, e;
        ...
        return d = $(b).find(".js-navigation-item.navigation-focus")[0] || b, c = $(d).fire("navigation:keydown", {
            originalEvent: a,
            hotkey: a.hotkey,
            relatedTarget: b
        }), c.result
        ...
        if (a !== b) return $(a).fire("navigation:activate", function () {
            return b && $(b).removeClass("js-active-navigation-container"), $(a).addClass("js-active-navigation-container"), $(a).fire("menu:activated", {
                async: !0
            })
        })
    }, f = function (a) {
        ...
        return $(a).fire("navigation:deactivate", function () {
            return $(a).removeClass("js-active-navigation-container"), $(a).fire("navigation:deactivated", {
                async: !0
            })
        })
    }, b = [], u = function (c) {
        ...
        var c, d;
        return b == null && (b = !1), (c = $(a).find(".js-navigation-open")[0]) ? (d = $.Event("click"), d["" + m + "Key"] = b, $.event.simulateClick(c, d)) : $(a).fire("navigation:open", {
            modifierKey: b
        }), !1
    }, e = function (a, b) {
        var c, d, e, f;
        ...
        return c = $(a).fire("navigation:focus", function () {
            return $(b).find(".navigation-focus.js-navigation-item").removeClass("navigation-focus"), $(a).addClass("navigation-focus"), $(a).fire("navigation:focused", {
                async: !0
            })
        ...
        if (c.bottom <= 0) return $(a).scrollTo({
            top: d.top - 30,
            duration: 200
        });
        if (c.top <= 0) return e = a.offsetParent != null ? a.scrollHeight : $(document).height(), f = e - (d.bottom + c.height), $(a).scrollTo({
            top: f + 30,
            duration: 200
        })
    }, v = function (a, b) {
        var c, d, e, f;
        d = $(b).positionedOffset(a), c = $(b).overflowOffset(a);
        if (c.bottom <= 0) return e = a.offsetParent != null ? a.scrollHeight : $(document).height(), f = e - (d.bottom + c.height), $(a).scrollTo({
            top: f
        });
        if (c.top <= 0) return $(a).scrollTo({
            top: d.top
        })
...
function () {
    $.fn.preservingScrollPosition = function (a) {
        var b, c, d, e;
        return b = this.overflowParent(), b[0].offsetParent == null && (b = $(window)), d = this.positionedOffset(b), e = b.scrollTop() - d.top, c = b.scrollLeft() - d.left, a.call(this), d = this.positionedOffset(b), b.scrollTo({
            top: e + d.top,
            left: c + d.left
        }), this
    }
...
function () {
    $.fn.touch = function (a) {
        var b, c, d, e, f;
        if (a) for (c = 0, e = this.length; c < e; c++) b = this[c], b.offsetHeight;
        else for (d = 0, f = this.length; d < f; d++) b = this[d], b.className = b.className;
        return this
    }
}.call(this),
function () {
    ...
    $.ajaxPoll = function (b) {
        ...
        function a(a) {
            this.onVisibilityChange = b(this.onVisibilityChange, this), this.onAjaxStop = b(this.onAjaxStop, this), this.onAjaxStart = b(this.onAjaxStart, this), this.onComplete = b(this.onComplete, this), this.onError = b(this.onError, this), this.onSuccess = b(this.onSuccess, this), this.onBeforeSend = b(this.onBeforeSend, this), this.poll = b(this.poll, this), this.pause = b(this.pause, this), this.resume = b(this.resume, this), this.stop = b(this.stop, this), this.start = b(this.start, this), this.original = $.extend({}, $.ajaxSettings, a), this.options = $.extend({}, a, {
                ...
                cache: !1,
                poller: this
            }), a.interval != null && (this.interval = a.interval, delete a.interval), a.decay != null && (this.decay = a.decay, delete a.decay), a.timeout != null && (this.timeout = a.timeout, delete a.timeout), this.interval = this.interval * 1e3, this.timeout = this.timeout * 1e3, this.start()
        }
...
}.call(this), window.GitHub || (window.GitHub = {}), window.GitHub.debug = !1,
function (a) {
    a.fn.autocompleteField = function (b) {
        ...
        return a(this).each(function () {
            function h(e) {
                ...
                if (c.useCache && g.hasOwnProperty(e)) b.trigger("autocomplete:finish", g[e]);
                else {
                    var f = {};
...
function (a) {
    a.fn.cardsSelect = function (b) {
        ...
        return this.each(function () {
            var b = a(this),
                d = b.next("dl.form").find("input[type=text]"),
                e = b.find(".card"),
                f = b.find("input[name='" + c.type_field + "']"),
                g = function (b) {
                    e.each(function () {
                        var c = a(this);
...
function (a) {
    a.fn.enticeToAction = function (b) {
        ...
        title: "You must be signed in to use this feature",
        direction: "downwards"
    }
}(jQuery),
function (a) {
...
function (a) {
    ...
    d.prototype = {
        ...
        return this.bind("tipsy.reload", function () {
...
function () {
    $(document).on("focusout", "input[data-autocheck-url]", function () {
        ...
        if (!$.trim(c)) return;
        return b.addClass("is-autocheck-loading"), b.removeClass("is-autocheck-successful is-autocheck-errored"), b.trigger("autocheck:send"), $.ajax({
            type: "POST",
            url: b.attr("data-autocheck-url"),
            data: {
                value: c
            },
            context: this,
    ...
    a = function () {
        ...
        return a.prototype.bindEvents = function (a, b) {
            ...
            return g = $(a).offset(), e = g.top, d = g.left, c = e + $(a).innerHeight(), f = $(a).innerWidth(), $(b).css({
                ...
                top: c + 5,
                left: d + 1
            }), $(a).addClass("js-navigation-enable"), $(b).find("ul").navigation("push"), $(b).show()
...
function () {
    $.pageUpdate(function () {
        ...
        if ($(".js-zeroclipboard").length) return a = new ZeroClipboard($(".js-zeroclipboard")), a.on("load", function (a, b) {
            ...
            var c;
            return c = $(a.htmlBridge), c.prop("title", $(this).attr("data-copied-hint")), c.trigger("tipsy.reload")
...
function () {
    ...
    c = function (a) {
        var b, c, e, f;
        return b = document.getElementById(a), c = document.getElementById("fullscreen_overlay"), f = "gh-fullscreen-theme", localStorage.getItem(f) === "dark" ? $(".js-fullscreen-overlay").addClass("dark-theme") : $(".js-fullscreen-overlay").removeClass("dark-theme"), $(c).attr("data-return-scroll-position", window.pageYOffset), $("body").addClass("fullscreen-overlay-enabled"), $(document).on("keydown", d), e = $(c).find(".js-fullscreen-contents"), $(e).attr("placeholder", $(b).attr("placeholder")), e.val($(b).val()), $(e).caret($(b).caret()), e.focus()
    }, b = function (a) {
        var b, c, e, f;
        return b = document.getElementById(a), c = document.getElementById("fullscreen_overlay"), $("body").removeClass("fullscreen-overlay-enabled"), $(document).off("keydown", d), (e = $(c).attr("data-return-scroll-position")) && window.scrollTo(0, e), f = $(c).find(".js-fullscreen-contents"), $(b).val(f.val()), $(b).caret($(f).caret()), window.editor != null && window.editor.setCode(f.val()), f.val("")
    }, e = !1, d = function (a) {
        if (a.keyCode === 27) return e ? history.back() : window.location.hash = "", a.preventDefault()
        ...
        var a;
        return a = "gh-fullscreen-theme", localStorage.getItem(a) === "dark" ? (localStorage.removeItem(a), $(".js-fullscreen-overlay").removeClass("dark-theme")) : (localStorage.setItem(a, "dark"), $(".js-fullscreen-overlay").addClass("dark-theme")), !1
    }), a = function (a, d) {
        var f;
        ...
        var b;
        return b = "gh-fullscreen-theme", localStorage.getItem(b) === "dark" && $(".js-fullscreen-overlay").addClass("dark-theme"), a(null, window.location.href)
    })
}.call(this),
function () {
...
function (a) {
    function b(b, d, e) {
        ...
        return this.on("click.pjax", b, function (b) {
            e = m(d, e), e.container || (e.container = a(this).attr("data-pjax") || f), c(b, e)
        })
    }
    function c(b, c, d) {
        d = m(c, d);
    ...
    function e(b) {
        ...
        var c = b.target,
            d = l(b.url).hash,
            f = b.context = n(b.container);
        b.data || (b.data = {}), b.data._pjax = f.selector;
        var i;
        b.beforeSend = function (a, c) {
            c.type !== "GET" && (c.timeout = 0), c.timeout > 0 && (i = setTimeout(function () {
                h("pjax:timeout", [a, b]) && a.abort("timeout")
            }, c.timeout), c.timeout = 0), a.setRequestHeader("X-PJAX", "true"), a.setRequestHeader("X-PJAX-Container", f.selector);
            var d;
            if (!h("pjax:beforeSend", [a, c])) return !1;
            b.requestUrl = l(c.url).href
        }, b.complete = function (a, c) {
            i && clearTimeout(i), h("pjax:complete", [a, c, b]), h("pjax:end", [a, b])
        }, b.error = function (a, c, d) {
            var e = p("", a, b),
                f = h("pjax:error", [a, c, d, b]);
            c !== "abort" && f && g(e.url)
            ...
            e.state = {
                ...
                fragment: b.fragment,
                timeout: b.timeout
            }, (b.push || b.replace) && window.history.replaceState(e.state, m.title, m.url), m.title && (document.title = m.title), f.html(m.contents), typeof b.scrollTo == "number" && a(window).scrollTop(b.scrollTo), (b.replace || b.push) && window._gaq && _gaq.push(["_trackPageview"]);
            if (d !== "") {
                var n = l(m.url);
    ...
    function p(b, c, d) {
        ...
        if (d.fragment) {
            var g = o(f, d.fragment).first();
            g.length && (e.contents = g.contents(), e.title || (e.title = g.attr("title") || g.data("title")))
        } else /<html/i.test(b) || (e.contents = f);
    ...
    function v() {
        a.fn.pjax = b, a.pjax = e, a.pjax.enable = a.noop, a.pjax.disable = w, a.pjax.click = c, a.pjax.submit = d, a.pjax.reload = f, a.pjax.defaults = {
            ...
            scrollTo: 0,
            maxCacheLength: 20
        }, a(window).bind("popstate.pjax", h)
    }
    function w() {
        a.fn.pjax = function () {
            return this
        }, a.pjax = i, a.pjax.enable = v, a.pjax.disable = a.noop, a.pjax.click = a.noop, a.pjax.submit = a.noop, a.pjax.reload = window.location.reload, a(window).unbind("popstate.pjax", h)
    }
    var q = {}, r = [],
        s = [];
...
function () {
    ...
    a = function () {
        ...
        return a = $("<li />").addClass("js-sortable-placeholder sortable-placeholder"), c.prototype.onMouseDown = function (b) {
            return $(b.currentTarget).addClass("js-sorting").fadeTo(0, .5).css({
                "z-index": 10,
                position: "absolute",
                top: $(b.currentTarget).position().top,
                left: $(b.currentTarget).position().left
            }).after(a), $(document).on("mousemove.sortable", this.onMouseMove), $(document).on("mouseup", this.onMouseUp), !1
            ...
            return $(".js-sorting").removeClass("js-sorting").fadeTo(0, 1).css({
                ...
                top: "",
                left: ""
            }), $(".js-sortable-placeholder").remove(), $(document).off("mousemove.sortable", this.onMouseMove), $(document).off("mouseup", this.onMouseUp), !1
        }, c.prototype.onMouseMove = function (a) {
            var b, c, d;
            return b = $(".js-sorting"), d = a.pageY - b.parent().offset().top, c = $(".js-sorting").height(), d < 0 + c / 2 ? $(".js-sorting").css({
                top: 0
            }) : d > b.parent().height() - c / 2 ? $(".js-sorting").css({
                top: b.parent().height() - b.height()
            }) : $(".js-sorting").css({
                top: d - c / 2
            }), $(".js-sorting").index() < b.parent().find(".js-sortable-target").length && $(".js-sorting").index() >= 0 && ($(".js-sorting").position().top > $(".js-sortable-placeholder").position().top + c * .8 ? ($(".js-sortable-placeholder").insertAfter($(".js-sortable-placeholder").next()), $(".js-sorting").insertBefore($(".js-sortable-placeholder"))) : $(".js-sorting").position().top < $(".js-sortable-placeholder").position().top - c * .8 && ($(".js-sortable-placeholder").insertBefore($(".js-sortable-placeholder").prev().prev()), $(".js-sorting").insertBefore($(".js-sortable-placeholder")))), !1
        }, c
    }(), new a
}.call(this),
function () {
    ...
    b = function (a) {
        ...
        var d, e, f, g;
        return e = c.parents(".js-comment"), g = e.find("form.edit_issue, form.js-comment-update"), d = e.find(".js-comment-body"), f = {
            item: c.attr("data-item-index"),
            checked: c.prop("checked") ? 1 : 0,
            body_version: d.attr("data-body-version")
        }, a(e), $.ajax({
            type: "post",
            url: g.attr("action") + "/task",
            data: f,
            dataType: "json",
            success: function (a) {
...
function () {
    ...
    b = null, f = null, e = !1, g = function (a) {
        ...
        var d;
        return d = !0, b && $(b).fire("drag:out", {
            originalEvent: a,
            dataTransfer: a.originalEvent.dataTransfer,
            relatedTarget: c
        }), c && $(c).fire("drag:over", {
            originalEvent: a,
            dataTransfer: a.originalEvent.dataTransfer,
...
function () {
    ...
    e = function () {
        ...
        return a.prototype.upload = function (a, b) {
            var c, d, e, f;
            return f = b.start || function () {}, e = b.progress || function () {}, c = b.complete || function () {}, d = b.error || function () {}, this.uploads.push({
                file: a,
                to: b.to,
                form: b.form || {},
                start: f,
            ...
            c = this.uploads.shift(), this.busy = !0, e = new XMLHttpRequest, e.open("POST", c.to, !0), e.setRequestHeader("X-CSRF-Token", this.token()), e.onloadstart = function (a) {
                ...
                var b;
                if (e.readyState === 4) return e.status === 204 ? (b = e.getResponseHeader("Location"), c.complete({
                    href: b
                })) : e.status === 201 ? c.complete(JSON.parse(e.responseText)) : c.error(), g.busy = !1, g.process()
        ...
        return b = ["image/gif", "image/png", "image/jpeg"], a = ["gif", "png", "jpg", "jpeg"], d.prototype.available = function () {
            ...
            return a()
        }, d.prototype.start = function (a) {}, d.prototype.progress = function (a) {}, d.prototype.complete = function (a) {}, d.prototype.error = function (a) {}, d.prototype.acceptsExtension = function (b) {
            var c;
        ...
        return c = $(b.container), d = {
            ...
            complete: function (d) {
                return $.ajax({
                    type: "PUT",
                    url: "" + b.uploadUrl + "/" + a.asset.id
                }), b.complete(a), b.field.trigger("change"), q(c)
            },
            error: function () {
        ...
        g = a.split("\r\n"), h = [];
        for (e = 0, f = g.length; e < f; e++) c = g[e], d.acceptsExtension(c) ? (d.start({
            name: ""
        }), h.push(d.complete({
            asset: {
                name: "",
        ...
        }))) : (p(b), h.push(b.addClass("is-bad-file")));
        return h
    }, h = function (a, b) {
        var c;
...
}.call(this), ZeroClipboard.setDefaults({
    moviePath: "/flash/ZeroClipboard.swf"
});
if (typeof console == "undefined" || typeof console.log == "undefined") window.console = {
    log: function () {}
};
window.debug = function () {}, window.GitHub.assetHostUrl = "https://a248.e.akamai.net/assets.github.com", $.ajaxPoll.version = "2", $.fn.spin = function () {
    return this.after('<img src="' + GitHub.Ajax.spinner + '" id="spinner" width="16" />')
}, $.fn.stopSpin = function () {
    return $("#spinner").remove(), this
}, GitHub.Ajax = {
    spinner: "https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-32.gif",
    ...
    var a = new Image;
    a.src = GitHub.Ajax.spinner, $(".cards_select").cardsSelect({
        type_field: "credit_card_type"
    ...
    loadingImage: "https://a248.e.akamai.net/assets.github.com/images/spinners/octocat-spinner-64.gif",
    closeHTML: '<span class="mini-icon mini-icon-remove-close"></span>',
    closeImage: ""
}),
function () {
    $.pageUpdate(function () {
...
function () {
    ...
    $(document).on("ajaxBeforeSend", ".js-new-comment-form", function (a, b) {
        ...
        return $(this).on("keydown.commentFocus", function (a) {
            ...
            if (a.hotkey === "ctrl+P" || a.hotkey === "meta+P") {
                b = $(this).closest(".js-previewable-comment-form");
                if (b.hasClass("write-selected")) return $(this).blur(), b.find(".preview-tab").click(), a.preventDefault(), a.stopImmediatePropagation()
            }
        ...
        var b;
        return b = a.find(".comment-body"), b.html("<p>Loading preview&hellip;</p>"), $.ajax({
            type: "POST",
            url: a.attr("data-preview-url"),
            data: {
                text: a.find(".js-comment-field").val()
            },
            success: function (a) {
...
function () {
    var a;
    a = null, $(document).on("change", ".js-period-container", function (b) {
        var c, d, e;
        b.preventDefault(), b.stopPropagation(), d = $(b.target).val().toLowerCase();
        if (a === d) return;
        c = $("<img />").addClass("dots").attr("src", "/images/spinners/octocat-spinner-128.gif"), $("#contribution-activity").html("").append(c);
        if ($.support.pjax) return a = d, e = "" + document.location.pathname + "?tab=contributions&period=" + a, $.pjax({
            url: e,
...
function () {
    $(document).on("click", ".js-git-protocol-selector", function () {
        var a, b, c;
        return a = $(this).closest(".url-box"), c = $(this).attr("href"), b = $(this).attr("data-permission"), a.find(".url-field").val(c), a.find(".js-zeroclipboard").attr("data-clipboard-text", c), a.find(".js-clone-url-permission").text(b), $(".js-live-clone-url").text(c), (c = $(this).attr("data-url")) && $.ajax({
            type: "POST",
            url: c
        }), a.find(".clone-urls > .selected").removeClass("selected"), $(this).parent("li").addClass("selected"), !1
    }), $(document).on("mouseup", ".url-field", function () {
        return $(this).select()
    })
}.call(this), $(function () {
    ...
    if ($("#edit_repo").length > 0) {
        ...
        var d = $("#push_pull_collabs input[data-autocomplete]"),
            e = $("#push_pull_collabs button[type=submit]"),
            f = null;
...
function () {
    ...
    $(document).on("click", ".add-bubble[data-remote]", function () {
        var b, c;
        return $(this).hasClass("loading") ? !1 : ($(this).closest(".file").addClass("show-inline-notes"), c = $(this).closest("tr"), b = c.next("tr.inline-comments"), b.length ? a(b) : $.ajax({
            context: this,
        ...
        return $(this).on("keydown.inlineCommentForm", function (a) {
            ...
            if (a.hotkey === "esc") return b = $(this).closest(".inline-comments"), b.find(".js-hide-inline-comment-form").click(), !1
...
function () {
    ...
    var c = a("#js-issues-quicksearch"),
        d = !0;
    if (c.length > 0) {
        var e = b.find(".js-new-issue-button"),
            f = c.offset();
...
function () {
    ...
    a = function () {
        var a, c, d, e, f;
        return e = [], a = $(".js-advanced-search-input").val(), f = {
            Repositories: 0,
            Users: 0,
            Code: 0
        }, e = b($("input[type=text].js-advanced-search-prefix"), function (a, b, c) {
            if (a === "") return "";
            b !== "" && f[c]++;
            if (b !== "") return "" + a + ":" + b
    ...
    $("#js-coupon-click-onload").click(), $(".selected .choose_plan").click(), $(".js-show-credit-card-form")[0] && ($.facebox({
    ...
    return $(document).one("reveal.facebox", function () {
        ...
        div: "#js-add-billing-contact-info-modal"
    }), !1
...
function () {
    ...
    b = function (a) {
        ...
        e = $(".line, .line-data");
        if (!e.length) return;
        e.css("background-color", ""), f = b(window.location.hash);
        if (f.length === 1) $("#LC" + f[0]).css("background-color", "#ffc");
        else if (f.length > 1) {
            c = f[0];
            while (c <= f[1]) $("#LC" + c).css("background-color", "#ffc"), c++;
            !d && (a = document.getElementById("LC" + f[0])) && a.scrollIntoView()
        }
        d = !1
    }, $(window).on("hashchange", f), $(f), c = function (a) {
        var b, c;
        return d = !0, b = (c = $(window).scrollTop()) != null ? c : 0, a(), $(window).scrollTop(b)
    }, $(document).on("mousedown", ".line-number, .line_numbers > span[rel]", function (d) {
        var e, f;
        return f = b($(this).attr("rel")), d.shiftKey && (e = b(window.location.hash), f.unshift(e[0])), c(function () {
...
function () {
    ...
    b = function (a) {
        ...
        var a, c, d, e;
        return d = $(this).closest("form"), a = d.find(".js-new-blob-commit-summary"), c = d.find(".js-blob-contents"), e = $(".js-gitignore-template"),
        function () {
            var f, g;
        ...
        var a;
        return a = $(this).closest(".js-file-commit-form"),
        function () {
        ...
        return c = a.closest("form"), b(c), $.ajaxPoll({
            interval: 2,
            url: a.attr("data-check-url"),
            success: function () {
                return a.hide(), b(c)
            },
            error: function (b) {
...
function () {
    ...
    var a = $("#compare").data("base"),
        b = $("#compare").data("head"),
        c = null;
    $(".compare-range .commit-ref.to").click(function () {
        return c = "end", $.facebox({
            div: "#compare_chooser"
        }), !1
    }), $(".compare-range .commit-ref.from").click(function () {
        return c = "start", $.facebox({
            div: "#compare_chooser"
        }), !1
    });
    var d = function () {
        var d = $("#facebox .ref-autocompleter"),
            e = $("#facebox button.choose-end"),
            f = $("#facebox button.refresh");
...
function () {
    $(function () {
        ...
        return b = function () {
            ...
            wrapperSelector: "",
            itemParentSelector: ".js-list-browser-item",
            enableShiftSelect: !0,
            ignoreLinks: !0
        ...
        }), a.selectableList(".js-color-chooser", {
            ...
            var b;
            return b = a.find(".js-list-browser-item.selected").length, a.find(".issues-list-actions .js-buttons").toggleClass("activated", b).toggleClass("deactivated", !b)
        }), a.find(":checked").removeAttr("checked"), a.on("click", ".js-issues-list-close", function () {
            var c;
            return $.ajax({
                type: "PUT",
                url: $(this).attr("data-url"),
        ...
        }), a.selectableList(".js-color-label-context .js-color-label-list"), a.on("click", ".js-issues-list .btn-label", function () {
            var b, c, d, e, f, g, h;
            d = a.find(".js-issues-list :checked").closest(".js-list-browser-item").find(".label"), c = a.find(".js-color-label-context"), c.find(".label a.selected").removeClass("selected"), c.find(":checked").attr("checked", !1), h = [];
            ...
            return $(this).menu("deactivate"), $.ajax({
                url: a.find(".js-color-label-context ul.color-label-list").attr("data-url"),
                type: "PUT",
                data: {
                    labels: function () {
                        var b, d, e, f;
    ...
    var b = a.find(".js-infobar .milestone .text"),
        c = a.find(".js-filterable-milestones").milestoneSelector();
...
function () {
    ...
    a = function (a) {
        ...
        return a($(this).closest(".js-notification")), $(this).closest(".js-notification").addClass("muted")
...
function () {
    $(document).on("focusin", "#organization_login", function () {
        ...
        var a;
        return a = document.getElementById("organization-transforming")
    })
}.call(this),
function () {
...
function () {
    ...
    }), $(document).on("ajaxSuccess", ".js-inline-comment-form", function () {}), $(this).closest("#discussion_bucket").length ? $("#files_bucket").remove() : $("#discussion_bucket").remove()
}.call(this),
function () {
    var a, b;
...
function () {
    $(function () {
        ...
        return $(document).on("navigation:open", ".js-create-tag", function () {
            var a, b, c, d, e, f;
            return b = $(this), d = $(".js-select-button"), c = $(".js-spinner"), a = $(".js-error"), e = $(".js-new-item-submit").val(), f = $(".js-create-tag").attr("data-url"), d.text("Creating tag..."), c.show(), a.hide(), $.ajax({
                url: f,
                type: "POST",
                data: {
                    tag_name: e
    ...
    a = function () {
        function a() {
            ...
            this.elements = {
                ...
                upsells: $(".js-upgrade"),
                upsellCardsSelect: $(".cards_select"),
            ...
            }, this.current_login = $("input[name=owner]:checked").prop("value"), this.privateRepo = !1, this.autocheckURL = this.elements.repoNameField.attr("data-autocheck-url"), this.changedPrivacyManually = !1, this.elements.teamBoxes.hide(), this.elements.ignoreContainer.on("change", "input[type=radio]", function () {
        ...
        return a.prototype.handleOwnerChange = function () {
            ...
            return a == null && (a = this.selectedPrivacyToggleElement()), b == null && (b = null), b && !b.isTrigger && (this.changedPrivacyManually = !0), a.val() === "false" ? (this.privateRepo = !0, this.elements.upgradeUpsell.show(), this.elements.upgradeUpsell.find("input[type=checkbox]").attr("checked", "checked"), this.elements.iconPreviewPublic.hide(), this.elements.iconPreviewPrivate.show(), this.elements.upgradeUpsell.find(".js-cc-upgrade").length ? this.elements.form.attr("action", this.elements.form.attr("data-tr-url")) : this.elements.form.attr("action", this.elements.form.attr("data-url")), this.elements.upsellCardsSelect.cardsSelect()) : (this.privateRepo = !1, this.elements.upgradeUpsell.hide(), this.elements.upgradeUpsell.find("input[type=checkbox]").attr("checked", null), this.elements.form.attr("action", this.elements.form.attr("data-url")), this.elements.iconPreviewPrivate.hide(), this.elements.iconPreviewPublic.show()), this.validate()
        ...
        if (b.bottom <= -10) return a.css({
            marginTop: b.bottom - 20
        })
    })
}.call(this),
function () {
...
function () {
    $.support.pjax && $(document).on("submit", ".js-stars-search", function (a) {
        var b;
        if (b = $(this).closest("[data-pjax-container]")[0]) return $.pjax.submit(a, {
            container: b
        })
    ...
    a = function () {
        ...
        return a.prototype.cache = {}, a.prototype.clickHandler = function (a) {
            ...
            this.state || (this.state = {
                ...
                direction: "forward",
                url: window.location.href
            }, window.history.replaceState(this.state, "")), this.cache[this.state.id] = $("#slider").clone()[0], b = $(a.currentTarget).attr("data-direction") || "forward", this.state = {
                id: (new Date).getTime(),
                direction: b,
                url: e
            }, window.history.pushState(this.state, "", e), typeof _gaq != "undefined" && _gaq !== null && _gaq.push(["_trackPageview"]), d(this.state, this.cache[this.state.id], this.state.direction)
        ...
        }, d === "back" ? ($(b).css("marginLeft", "-1200px"), $(a).before(b), $(b).animate({
            marginLeft: "0"
        }, g, f)) : ($(b).css("marginLeft", "0"), $(a).after(b), $(a).animate({
            marginLeft: "-1200px"
        }, g, f))
    }, h = function (a, b, c, d) {
        ...
        if (!j(".breadcrumb:visible")) return $(".breadcrumb:visible").scrollTo({
            duration: 50
        })
    }, j = function (a) {
        var b, c, d, e;
...
function () {
    ...
    var a = $("table.billing-plans"),
        b = a.find("tr.selected .choose_plan"),
        c = a.find("tr.current"),
        d = $("#plan"),
...
function () {
    ...
    }), a = ["is-default", "is-saving", "is-failed"], b = function (b, c) {
        return b.removeClass(a.join(" ")), b.addClass(c), c === "is-saving" ? b.attr("disabled", "disabled") : b.removeAttr("disabled")
    }, $(document).on("click", ".js-save-draft", function (a, c) {
        var d, e, f, g;
        return $("#release_draft").val("true"), d = $(this), f = d.closest("form"), g = f.attr("action"), e = f.serialize(), b(d, "is-saving"), $.ajax({
            url: g,
            type: "POST",
            data: e,
            dataType: "json",
            success: function (a) {
                var e;
                e = $("#release_id"), e.val() || (e.val(a.id), f.attr("action", "" + g.slice(0, -1) + "/" + a.tag_name), f.append('<input type="hidden" id="release_method" name="_method" value="put" />')), b(d, "is-default");
                if (c) return c()
            },
            complete: function () {},
            error: function (a) {
                return b(d, "is-failed")
            }
        }), a.preventDefault()
    }), $(document).on("click", ".js-publish-release", function (a) {
        return $("#release_draft").val("false")
    }), $(document).on("click", ".js-filter-refs .js-navigation-item", function (a) {
        var b, c, d, e;
        return d = $(a.target).find("input[type=radio]").val(), b = $(".js-release-form"), c = b.attr("data-repo-url"), e = "" + c + "/releases/" + d, $.ajax({
            url: e,
            type: "GET",
            dataType: "json",
            success: function (a) {
                a.id != null ? e = "" + c + "/releases/" + a.tag_name + "/edit" : e = "" + c + "/releases/new?tag_name=" + d;
                if (window.location.pathname !== e) return window.location.href = e
            },
            complete: function () {},
            error: function (a) {}
        })
...
function () {
    $(function () {
        ...
        $("#page-settings").on("click", ".js-add-email", function (a) {
            ...
            var b;
            return b = $(this), b.parents("li").append('<img class="spinner" src="' + GitHub.Ajax.spinner + '" width="16" />'), $.ajax({
                url: b.parents(".js-notifications-settings").attr("data-toggle-url"),
                type: "POST",
                data: b.parents(".js-notifications-settings").serialize(),
                complete: function () {
            ...
            var b, c, d, e;
            return c = $(a.currentTarget), d = c.parent("div").parent("div").attr("data-repo"), e = $('ul.repositories li[data-repo="' + d + '"]'), b = c.parents("div.full-button"), b.addClass("no-bg"), b.html('<img src="' + GitHub.Ajax.spinner + '" width="16" />'), $.ajax({
        ...
        if ($(".js-name-change-in-progress").length) return $.ajaxPoll({
    ...
    a = function () {
        ...
        return a.prototype.setup = function () {
            ...
            this.source = new EventSource(this.url), this.source.addEventListener("message", function (a) {
                ...
                for (d = 0, e = f.length; d < e; d++) c = f[d], a.send({
                    subscribe: c
                })
            ...
            return document.hidden || document.webkitHidden || document.mozHidden || document.msHidden ? this.send({
                visibility: "hidden"
            }) : this.send({
                visibility: "visible"
            })
            ...
            if (a = this.popMessages()) return $.ajax({
                type: "POST",
            ...
            return this.channels.push(a), this.send({
                subscribe: a
            })
        }, a
        ...
        var d, e, f, g, h, i;
        f = !1, b = {}, i = $(".js-socket-channel");
        for (g = 0, h = i.length; g < h; g++) d = i[g], f = !0, e = $(d).attr("data-channel"), b[e] = d;
        if (f) {
            if (c != null ? !c.url : !void 0) c = new a("/_sockets");
            for (e in b) d = b[e], c.subscribe(e)
...
function () {
    ...
    a = function () {
        ...
        return c.prototype.types = {
            ...
            return d = function () {
                switch (a.search) {
                    case "fuzzy-hashed":
                        return c.fuzzyFilterSortList("#" + b, {
                            limit: a.limit
                        });
                    case "fuzzy":
                        return c.fuzzyFilterSortList(b, {
    ...
    function a(a, b) {
        var c = Math.min(a.canvas.width, b.canvas.width),
            d = Math.min(a.canvas.height, b.canvas.height),
            e = a.getImageData(0, 0, c, d),
    ...
    if ($("#files .image").length) {
        var b = $("#files .file:has(.onion-skin)"),
            c = [];
        $.each(b, function (d, e) {
            function E() {
                A++, H();
            ...
            function F(a) {
                ...
                if (e.hasClass("active") == 0 && e.hasClass("disabled") == 0) {
                    ...
                    A >= 2 && (animHeight = parseInt(x.eq(a).css("height")) + 127, f.css("height", animHeight), d.animate({
                        opacity: "hide"
                    }, 250, "swing", function () {
                        x.eq(a).fadeIn(250)
                    }))
            ...
            function G() {
                var b = 858,
                    e = Math.max(B.width, C.width),
                    k = Math.max(B.height, C.height),
                    l = 0,
                    x = 1;
                ...
                e > b - 12 && (A = (b - 12) / e), D = 0, D = e * A + 3, o.attr({
                    ...
                    margin: B.marginVert * A + "px " + B.marginHoriz * A + "px",
                    width: B.width * A + 2,
                    height: B.height * A + 2
                }), h.find(".added-frame").css({
                    margin: C.marginVert * A + "px " + C.marginHoriz * A + "px",
                    width: C.width * A + 2,
                    height: C.height * A + 2
                    ...
                    width: e * A + 18 + "px",
                    height: k * A + 30 + "px"
                }), h.find(".swipe-bar").css("left", l * D + "px"), f.find(".swipe .swipe-shell").css("width", D - D * l), h.find(".swipe-bar").on("mousedown", function (a) {
                    var b = $(this),
                        e = $(this).parent(),
                        g = 0,
                        h = e.width() - b.width();
                ...
                e > b - 12 && (E = (b - 12) / e), q.attr({
                    ...
                    margin: B.marginVert * E + "px " + B.marginHoriz * E + "px",
                    width: B.width * E + 2,
                    height: B.height * E + 2
                }), i.find(".added-frame").css({
                    margin: C.marginVert * E + "px " + C.marginHoriz * E + "px",
                    width: C.width * E + 2,
                    height: C.height * E + 2
                }), i.find(".onion-skin-frame").css({
                    width: e * E + 4 + "px",
                    height: k * E + 30 + "px"
                }), f.find(".dragger").css("left", x * 262 + "px"), f.find(".onion-skin .added-frame").css("opacity", x), f.find(".onion-skin .added-frame img").css("opacity", x), f.find(".dragger").on("mousedown", function (a) {
                    var b = $(this),
                        e = $(this).parent(),
                        g = 0,
                        h = e.width() - b.width();
                ...
                var G = 1;
                e > b - 4 && (G = (b - 4) / e), Modernizr.canvas && (s.attr({
                    width: e * G,
                    height: k * G
                }), t.attr({
                    width: e * G,
                    ...
                    width: e * G + 2,
                    height: k * G + 2
                }), u.drawImage(B, B.marginHoriz * G, B.marginVert * G, B.width * G, B.height * G), v.drawImage(C, C.marginHoriz * G, C.marginVert * G, C.width * G, C.height * G), a(v, u)), g.css("height", k * z + 30), h.css("height", k * A + 30), i.css("height", k * A + 30), j.css("height", k * A + 30), w.children().removeClass("disabled"), F(y)
            }
            function H() {
                var a = A / z * 100 + "%";
            ...
            var f = b.eq(d),
                g = f.find(".two-up").eq(0),
                h = f.find(".swipe").eq(0),
                i = f.find(".onion-skin").eq(0),
                j = f.find(".difference").eq(0),
                k = f.find(".deleted"),
                l = f.find(".added"),
                m = k.eq(0),
                n = l.eq(0),
                ...
                q = k.eq(2),
                r = l.eq(2),
                s = f.find("canvas.deleted").eq(0),
                t = f.find("canvas.added").eq(0),
                u, v, w = f.find("ul.view-modes-menu"),
                x = f.find(".view"),
                y = 0,
                z = f.find(".asset").length,
                A = 0,
                B = new Image,
                C = new Image;
            c.push({
...
function () {
    ...
    b = function (a) {
        ...
        return h.prototype.filter = function (a, b) {
            var h;
            return h = d(this.suggestions), h = c(h, a, b), h = f(h), h = g(h), h = e(h), h.push({
                command: "Search GitHub for '" + a + "'",
                description: "",
                type: "choice",
                multiplier: 1,
                filter: !0
...
function () {
    ...
    CommandBar.Context.prototype.execute = function () {
        ...
        return c(b, a), b.contexts = [], b.regex = /search github for '(.+)'/i, b.help = function () {
            ...
            return this.loading("Searching for '" + this.query() + "'"), this.goToUrl("/search?utf8=âœ“&q=" + this.query() + "&ref=searchcontext")
        }, b
...
function () {
    ...
    a = function (a) {
        ...
        return j(b, a), b.contexts = [], b.regex = /pulls/i, b.help = function () {
            return {
                command: "pulls",
                description: "View your pull requests"
            }
        }, b.prototype.suggestionOptions = function () {
            return [{
                command: "pulls",
        ...
        return j(b, a), b.contexts = [], b.regex = /profile/i, b.help = function () {
            return {
                command: "profile",
                description: "View your public user profile"
            }
        }, b.prototype.suggestionOptions = function () {
            return [{
                command: "profile",
        ...
        return j(b, a), b.contexts = [], b.regex = /settings/i, b.help = function () {
            return {
                command: "settings",
                description: "View or edit your account settings"
            }
        }, b.prototype.suggestionOptions = function () {
            return [{
                command: "settings",
...
function () {
    ...
    b = function (a) {
        ...
        return l(b, a), b.contexts = [], b.regex = /^([\w\._-]+\/[\w\._-]+)/i, b.help = function () {
            ...
            var a, b, c;
            a = this.lazyLoad("/command_bar/repos", {
                loadingMessage: "Loading your repos",
                process: function (a) {
                    return a.repositories
                }
            });
            if (c = this.text.match(/([\w-_]+)\//i)) b = c[1], a = this.lazyLoad("/command_bar/repos_for/" + b, {
        ...
        return l(b, a), b.contexts = [], b.regex = /(?:@|branch)([\w-_\/]+)?/i, b.help = function () {
            ...
            return this.text.match(/@/i) ? this.lazyLoad("/command_bar/" + this.repo() + "/branches", {
        ...
        return l(b, a), b.contexts = [], b.regex = /\#\s?(\d+)?/i, b.help = function () {
            ...
            return this.text.match(/#/i) ? this.lazyLoad("/command_bar/" + this.repo() + "/issues", {
        ...
        return l(b, a), b.contexts = [], b.regex = /#((?:\s+)?(?:[0-9]+)?[a-zA-Z][\w\s0-9]*)/i, b.help = function () {
            ...
            var a, b, c;
            return c = this.term(), b = this.constructor.previous_term, clearTimeout(this.constructor.timeout), this.constructor.previous_term = c, c.match(/\w/i) && c.length > 2 ? c === b && this.searchDelayPassed() ? this.lazyLoad("/command_bar/" + this.repo() + "/issues_search?q=" + this.term(), {
        ...
        return l(b, a), b.contexts = [], b.regex = /(watch|unwatch)/i, b.help = function () {
            ...
            return this.loading("Requesting to " + this.action() + " " + this.repo()), this.post({
                url: "/command_bar/" + this.repo() + "/" + this.action(),
                success: function () {
...
function () {
    ...
    b = function (a) {
        ...
        return e(b, a), b.contexts = [], b.regex = /@([A-Za-z0-9-_]+)\/?/i, b.help = function () {
            ...
            return this.lazyLoad("/command_bar/users", {
        ...
        return e(b, a), b.contexts = [], b.regex = /(follow|unfollow)/i, b.help = function () {
            ...
            return this.loading("Requesting to " + this.action() + " " + this.user()), this.post({
                url: "/command_bar/" + this.user() + "/" + this.action(),
                success: function () {
